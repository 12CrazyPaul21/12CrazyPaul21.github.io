...
要注意的是：文章中的内容用在指导开发过程时也**不需要盲目地遵守**的，要**根据实际情况灵活的变动**。
...
<center><font size="2"><a href="https://www.infoq.cn/article/OFx8xxEVXtsIpYXldsqA">图来自：《深入浅出了解 OKR（十）：OKR 在敏捷转型中的实践》 by 大叔杨</a></font></center>
...
这里不讨论OKR执行的具体过程，需要详细了解的可以读读下面几篇文章。
